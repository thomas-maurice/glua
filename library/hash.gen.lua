...
---@return string The hex-encoded MD5 hash
function hash.md5(str) end

---@param str string The string to hash
---@return string The hex-encoded SHA1 hash
