...
---@return string|nil Error message if writing failed, nil on success
...
---@return string|nil Error message if removal failed, nil on success
...
---@return table Array of entry names, or nil on error
---@return string|nil Error message if listing failed
function fs.list(path) end

---@param path string The path to stat
---@return table File info with name, size, is_dir, mode, mod_time, or nil on error
---@return string|nil Error message if stat failed
